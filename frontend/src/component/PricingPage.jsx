      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Choose the perfect plan to power your quiz contests and engage your audience like never before
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {plans.map((plan) => {
            ...
            const finalPrice = isAnnual ? Math.round(plan.price * 0.8*12) : plan.price;
            ...
            return (
              ...
              >
                ...
                <div className={`relative h-full bg-slate-800/50 backdrop-blur-lg rounded-2xl border border-slate-700 overflow-hidden ${
                  plan.popular ? 'ring-2 ring-yellow-400' : ''
                }`}>
                  {/* Gradient Background */}
                  <div className={`absolute top-0 left-0 right-0 h-32 bg-gradient-to-br ${plan.color} opacity-20`}></div>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-slate-800/30 backdrop-blur-lg rounded-xl p-6 border border-slate-700">
              ...
              <p className="text-gray-400">Create engaging quizzes in minutes with our intuitive builder</p>
            </div>
            <div className="bg-slate-800/30 backdrop-blur-lg rounded-xl p-6 border border-slate-700">
              <Users className="w-12 h-12 text-cyan-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Engage Audiences</h3>
              <p className="text-gray-400">Real-time participation and instant results keep users hooked</p>
            </div>
            <div className="bg-slate-800/30 backdrop-blur-lg rounded-xl p-6 border border-slate-700">
              <Trophy className="w-12 h-12 text-orange-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Track Success</h3>
              <p className="text-gray-400">Detailed analytics help you understand and improve performance</p>
            </div>
          </div>
        </div>
