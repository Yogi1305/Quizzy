                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            <Link to="/login" className="text-gray-300 hover:text-white transition-all duration-300 px-4 py-2 rounded-full text-sm font-medium hover:bg-white/10 backdrop-blur-sm hover:scale-105">Login</Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-4 relative z-10">
                <div className="max-w-md w-full">
                    <div className="group relative bg-gradient-to-br from-purple-900/50 to-pink-900/50 backdrop-blur-sm rounded-3xl shadow-2xl border border-purple-500/30 hover:border-purple-400/60 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 overflow-hidden">
                        ...
                        <div className="p-8 relative z-10">
                            <div className="mb-8 text-center">
                                <QuizLogo />
                                <h2 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-pink-200 mt-6 mb-2 leading-tight tracking-tight">Reset Password</h2>
                                <p className="text-xl text-gray-300 leading-relaxed">Enter your email and new password</p>
                            </div>
                            ...
                            <form onSubmit={handlesubmmit} className="space-y-6">
                                ...
                                {/* New Password */}
                                <div className="space-y-2">
                                    <label className="block text-sm font-bold text-white tracking-wide">New Password</label>
                                    <div className="relative group">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <svg className="h-5 w-5 text-purple-300 group-focus-within:text-purple-400 transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                {/* Confirm Password */}
                                <div className="space-y-2">
                                    <label className="block text-sm font-bold text-white tracking-wide">Confirm Password</label>
                                    <div className="relative group">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <svg className="h-5 w-5 text-purple-300 group-focus-within:text-purple-400 transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="mt-8 text-center">
                                <p className="text-sm text-gray-300">
                                    ...
                                    <Link to="/login" className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 hover:from-purple-300 hover:to-pink-300 hover:underline transition-all duration-300 hover:scale-105">
                                        Sign in here
                                    </Link>
                                </p>
                            </div>
                    ...
                    <div className="mt-8 text-center text-sm text-gray-400">
                        <p>Need help? <span className="underline cursor-pointer hover:text-white transition-colors duration-200 hover:scale-105">Contact Support</span></p>
                    </div>
                </div>
            </div>
